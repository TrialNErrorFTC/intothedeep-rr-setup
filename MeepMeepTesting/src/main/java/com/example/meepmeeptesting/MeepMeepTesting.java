...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .build();
        TrajectoryActionBuilder preclipDropPosition = myBot.getDrive().actionBuilder(new Pose2d(14, 62, Math.toRadians(180)))
                .lineToX(56-8)
                .endTrajectory();
        ...
        myBot.runAction(new SequentialAction(
                ...
                goToRegularDropPosition.build(),
                goToSecondBlock.build()
        ));
